...
(function(GUI) {
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------
	function checkPos() {
		GUI.debugging( 'Scroll: Running checkPos', 'report' );
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------
	module.init = function headersInit() {
		GUI.debugging( 'headers: Initiating', 'report' );

		if( $body.length ) {
			GUI.debugging( 'headers: Found `.js-body` instance', 'report' );

			// Bind to window scroll
			$window.on('scroll', GUI.throttle(checkPos, 15));
